...
public class Gorilla extends StateMachine {
    ...
    public Gorilla(float startX, float startY, Player player) {
        ...
        anim = new AnimationComponent("gorilla", pos, SCALE, new Vector2());
    ...
    private void setupAnimation(Animator a) {
        ...
        a.addAnimation(new Animation("sit", Animation.AnimationPlayState.REPEAT, FrameRate.perFrame(0.2f), atlas.findRegions("gorilla/sit").toArray(AnimagicTextureRegion.class)));
