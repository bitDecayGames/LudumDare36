...
public class GorillaDeath extends GameObject implements IRemoveable {
    private AnimationComponent anim;
    private PositionComponent pos;

    public GorillaDeath(PositionComponent pos, Facing facing) {
        this.pos = pos;

        anim = new AnimationComponent(ResourceDir.path("assets/main/gorilla/death"), pos, .5f, new Vector2(0, 0));
        AnimagicTextureAtlas atlas = LudumDareGame.atlas;
        anim.animator.addAnimation(new Animation("death", Animation.AnimationPlayState.ONCE, FrameRate.perFrame(.13f), atlas.findRegions("gorilla/death").toArray(AnimagicTextureRegion.class)));
